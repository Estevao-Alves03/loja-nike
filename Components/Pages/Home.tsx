      ...
      <div>
          ...
          <main>
                ...
                <div className="grid grid-cols-3 gap-5 justify-around items-center p-10">
                    <section className="flex justify-center">
                        <div className="h-96 w-80 bg-cover bg-center rounded-md border-4 border-black"
                            ...
                            <Link to="#">
                                <Button className="ml-6 mt-56 bg-black hover:bg-black hover:text-yellow-400" type="submit">Buy now</Button>
                            </Link>
                        </div>
                    </section>
                    <section className="flex justify-center">
                ...
                <div className="flex justify-between items-center pb-5">
                    ...
                    <Button className=" bg-black hover:bg-black hover:text-yellow-400 mr-16 font-bold px-7 py-5 rounded-xl">
                    Pesquisar
                    <HiOutlineMagnifyingGlass  className="ml-3"/>
                    </Button>
                </div>
                ...
                <div className="grid grid-cols-5 gap-5 p-5 pt-0 mb-5 mt-5">
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/1">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl border-4 border-black "
                             style={{backgroundImage : `url("/img/portugal.png")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/2">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/alemanha.jpeg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/3">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/bayer.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/4">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/real.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/5">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/brasil.jpeg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/6">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/argentina.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/7">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                             style={{backgroundImage : `url("/img/united.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/8">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                            style={{backgroundImage : `url("/img/psg.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">                                                  
                        <Link to="./Products/9">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                            style={{backgroundImage : `url("/img/city.jpg")`}}></div>
                        </Link>
                    ...
                    <section className="flex flex-col justify-center items-center">
                        <Link to="./Products/10">
                            <div className="h-72 w-56 bg-cover bg-center rounded-2xl  border-4 border-black"
                            style={{backgroundImage : `url("/img/barcelona.jpg")`}}></div>
                        </Link>
